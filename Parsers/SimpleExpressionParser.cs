...
namespace FunctionFullAnalysis.Parsers
{
    public class SimpleExpressionParser
    {
		...
		protected internal virtual Parser<Expression> Factor =>
			ExpressionInParentheses.XOr(Constant).XOr(ParameterX);
		...
		public virtual Expression<Func<double, double>> ParseExpression(string text) =>
			Lambda.Parse(text) as Expression<Func<double, double>>;
	}
}
